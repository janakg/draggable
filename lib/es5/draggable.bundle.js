...
var Draggable = function () {
  ...
  function Draggable() {
    ...
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    var hosts = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [document];
    ...
    this.hosts.forEach(function (host) {
      host.addEventListener('drag:start', _this[onDragStart], true);
      host.addEventListener('drag:move', _this[onDragMove], true);
      host.addEventListener('drag:stop', _this[onDragStop], true);
      host.addEventListener('drag:pressure', _this[onDragPressure], true);
    });
  ...
  (0, _createClass3.default)(Draggable, [{
    ...
    value: function destroy() {
      ...
      this.hosts.forEach(function (host) {
        host.removeEventListener('drag:start', _this2[onDragStart], true);
        host.removeEventListener('drag:move', _this2[onDragMove], true);
        host.removeEventListener('drag:stop', _this2[onDragStop], true);
        host.removeEventListener('drag:pressure', _this2[onDragPressure], true);
      });
    ...
    value: function addSensor() {
      ...
      var activeSensors = sensors.map(function (Sensor) {
        return new Sensor(_this4.containers, _this4.options, _this4.hosts);
      });
    ...
    value: function getDraggableElements() {
      ...
      return this.containers.reduce(function (current, container) {
        return [].concat((0, _toConsumableArray3.default)(current), (0, _toConsumableArray3.default)(_this5.getDraggableElementsForContainer(container)));
      }, []);
    }
    ...
    value: function getDraggableElementsForContainer(container) {
      ...
      return [].concat((0, _toConsumableArray3.default)(allDraggableElements)).filter(function (childElement) {
        return childElement !== _this6.originalSource && childElement !== _this6.mirror;
      });
    }
    ...
    value: function value(event) {
      ...
      this.hosts.forEach(function (host) {
        host.documentElement.classList.add(_this7.getClassNameFor('body:dragging'));
        applyUserSelect(host.documentElement, 'none');
      });

      requestAnimationFrame(function () {
        var oldSensorEvent = getSensorEvent(event);
        var newSensorEvent = oldSensorEvent.clone({ target: _this7.source });

        _this7[onDragMove](Object.assign({}, event, {
    ...
    value: function value(event) {
      ...
      this.hosts.forEach(function (host) {
        host.documentElement.classList.remove(_this8.getClassNameFor('body:dragging'));
      ...
      this.placedTimeoutID = setTimeout(function () {
        if (_this8.lastPlacedSource) {
          _this8.lastPlacedSource.classList.remove(_this8.getClassNameFor('source:placed'));
        }

        if (_this8.lastPlacedContainer) {
          _this8.lastPlacedContainer.classList.remove(_this8.getClassNameFor('container:placed'));
        }

        _this8.lastPlacedSource = null;
        _this8.lastPlacedContainer = null;
...
var MouseSensor = function (_Sensor) {
  ...
  function MouseSensor() {
     ...
     * @type {Boolean}
     */
    var _this = (0, _possibleConstructorReturn3.default)(this, (MouseSensor.__proto__ || Object.getPrototypeOf(MouseSensor)).call(this, containers, options, hosts));
  ...
  (0, _createClass3.default)(MouseSensor, [{
    ...
    value: function value(event) {
      ...
      var currentHost = event.view.document;


      this.startedInsideIframe = Boolean(document !== currentHost);

      this.initialHost = currentHost;
      this.iframeElements = [].concat((0, _toConsumableArray3.default)(document.querySelectorAll('iframe')));

      this.addHostsEventListener('mouseup', this[onMouseUp]);
      currentHost.addEventListener('dragstart', preventNativeDragStart);

      var target = currentHost.elementFromPoint(event.clientX, event.clientY);
      ...
      this.mouseDownTimeout = setTimeout(function () {
        ...
        if (_this2.dragging) {
          _this2.addHostsEventListener('contextmenu', _this2[onContextMenuWhileDragging]);
          _this2.addHostsEventListener('mousemove', _this2[onMouseMove]);
        }
      }, this.options.delay);
    }
    ...
    value: function value(event) {
      ...
      if (this.startedInsideIframe && (clientX < 0 || clientY < 0)) {
        var iframeElements = [].concat((0, _toConsumableArray3.default)(document.querySelectorAll('iframe')));
        var iframeElement = iframeElements.find(function (iframe) {
          return iframe.contentDocument === currentHost;
        });

        var _iframeElement$getBou = iframeElement.getBoundingClientRect(),
            top = _iframeElement$getBou.top,
            left = _iframeElement$getBou.left;
...
var Sensor = function () {
  ...
  function Sensor() {
     ...
     * @type {DocumentOrShadowRoot[]}
     */
    this.hosts = [].concat((0, _toConsumableArray3.default)(hosts));
  ...
  (0, _createClass3.default)(Sensor, [{
    ...
    key: 'addHostsEventListener',
    value: function addHostsEventListener(type, callback, options) {
      this.hosts.forEach(function (host) {
        host.addEventListener(type, callback, options);
      });
    }
  }, {
    key: 'removeHostsEventListener',
    value: function removeHostsEventListener(type, callback, options) {
      this.hosts.forEach(function (host) {
...
function matchFunction(_ref) {
  var view = _ref.defaultView;

  return view.Element.prototype.matches || view.Element.prototype.webkitMatchesSelector || view.Element.prototype.mozMatchesSelector || view.Element.prototype.msMatchesSelector;
}
...
function closest(element, value) {
  ...
  var host = element.ownerDocument;
...
var Scrollable = function (_AbstractPlugin) {
  ...
  (0, _createClass3.default)(Scrollable, [{
    ...
    value: function value() {
      ...
      var view = this.scrollableElement.ownerDocument.defaultView;
      ...
      var documentScrollingElement = getDocumentScrollingElement(view.document);
...
function hasOverflow(element) {
  ...
  var computedStyles = view.getComputedStyle(element, null);
...
function isStaticallyPositioned(element) {
  ...
  var position = view.getComputedStyle(element).getPropertyValue('position');
...
function positionMirror() {
  ...
  return function (_ref9) {
    ...
    return withPromise(function (resolve) {
      ...
      if (mirrorOffset) {
        var currentHost = sensorEvent.originalEvent.view.document;
